...
import { loginUser } from "@services/redux/actions/LoginAction";
...
export default reduxForm({ form: "loginUser", enableReinitialize: true })(
  connect(mapStateToProps, mapDispatchToProps)(LoginJobhunt)
);
